...
namespace MvcHomework2.Controllers
{
    public class 客戶銀行資訊Controller: BaseController
    {
        ...
        {
            var 客戶銀行資訊 = repo.AllIncluding(i => i.客戶資料); //db.客戶銀行資訊.Include(客 => 客.客戶資料);
        ...
        {
            ViewBag.客戶Id = new SelectList(customerRepo.All() /*db.Customers*/, "Id", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,客戶Id,銀行名稱,銀行代碼,分行代碼,帳戶名稱,帳戶號碼")] 客戶銀行資訊 客戶銀行資訊)
        {
            ...
            ViewBag.客戶Id = new SelectList(customerRepo.All() /*db.Customers*/, "Id", "Name", 客戶銀行資訊.客戶Id);
            return View(客戶銀行資訊);
        }
